...
__all__ = [
    'PanopticDeepLab_4_ViT',
    'PanopticDeepLabPR_4_ViT',
    'PanopticDeepLabBC_4_ViT'
]
    
class PanopticDeepLab_4_ViT(nn.Module):
    def __init__(
        self,
        encoder='resnet50',
        num_classes=1,
        ...
        **kwargs
        ...
        super(PanopticDeepLab_4_ViT, self).__init__()
        ...
        self.interpolate = Interpolate2d(16, mode='bilinear', align_corners=True)
...
class PanopticDeepLabPR_4_ViT(PanopticDeepLab_4_ViT):
    def __init__(
        self,
        num_fc=3,
        ...
        **kwargs
        ...
        super(PanopticDeepLabPR_4_ViT, self).__init__(**kwargs)
...
class PanopticDeepLabBC_4_ViT(PanopticDeepLab_4_ViT):
    def __init__(
        self,
        num_fc=3,
        train_num_points=1024,
        ...
        **kwargs
        ...
        super(PanopticDeepLabBC_4_ViT, self).__init__(**kwargs)
